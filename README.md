...
GitHub Mobile から完了確認するときは、次の順で見ると判断しやすいです。

1. Issue に対応する PR があるか
2. PR の差分が目的に合っているか
3. GitHub Actions の CI が成功しているか
4. 必要なら PR 本文の確認結果や run_id が埋まっているか

最低限の完了判定としては、次の 2 つを満たせば十分です。

- PR が作成されている
- GitHub Actions のチェックが緑になっている

画像や音声の変更では、必要に応じて追加で次も確認してください。

- 該当 run_id が PR コメントや本文に書かれている
- 生成物の意図が Issue の完了条件を満たしている
